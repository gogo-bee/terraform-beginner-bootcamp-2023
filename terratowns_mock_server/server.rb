...
class Home
  ...
  # Create some attributes to be stored on this object
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # if we cant find it then return an error or if it doent match
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # printing them out to console to make it easier  
